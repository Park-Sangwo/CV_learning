...
Diagnostic Capability(understanding the underlying cause of the failure),
Data Synthesis(because of requirement of enormous datasets), 


4. How our human visual system works?
1) physical world are first captured by our two eyes
2) begins in the eye itself, where cells in the retina process and reduce the raw information
3) This processed information travels via the optic nerve to the lateral geniculate nucleus
